...
const int BUTTON_PIN   = 2; // Digital IO pin connected to the button. This will be
// driven with a pull-up resistor so the switch should
// pull the pin to ground momentarily.  On a high -> low
// transition the button press logic will execute.
// This pin must support interrupts.

const int PIXEL_PIN   =  3; // Digital IO pin connected to the NeoPixels.
const byte LED_PIN    = 13; // On board LED.
const int PIXEL_COUNT = 60; // Number of pixels.
...
void breakableDelay( unsigned long delay) {
